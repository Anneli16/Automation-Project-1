...
describe('This is first test suite, Anneli Oja', () => {
    it('User can submit data only when valid mandatory values are added', () => {
        //26.04.2024
        cy.get('[data-testid="phoneNumberTestId"]').type('555666777')
        cy.get('#firstName').type('Kulla')
        cy.get('#lastName').type('Kallis')
        cy.get('input[name="password"]').type('Testpassword6')
        cy.get('[name="confirm"]').type('Testpassword6')
    ...
    */
    ...
    it('User cannot submit data when phone number is absent', () => {
        ...
        cy.get('#phoneNumber').should('have.attr', 'title')
